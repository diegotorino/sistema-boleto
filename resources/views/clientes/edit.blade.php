<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <i class="fas fa-user-edit mr-2"></i>{{ __('Editar Cliente') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-4">
                        <p class="text-gray-600 dark:text-gray-400">
                            <i class="fas fa-info-circle mr-2"></i>Edite os dados do cliente abaixo
                        </p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('clientes.update', $cliente) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="cpf_cnpj" class="block mt-1 w-full" type="text" name="cpf_cnpj" :value="old('cpf_cnpj', $cliente->cpf_cnpj)" required />
