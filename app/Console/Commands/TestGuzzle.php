...
class TestGuzzle extends Command
{
    ...
    protected $description = 'Testa a conexão com o Banco Inter usando Guzzle';

    public function handle()
    {
        $this->info('Testando conexão com o Banco Inter usando Guzzle...');
        ...
        try {
            ...
            $client = new Client([
                'verify' => false,
                'cert' => storage_path('app/private/Sandbox_InterAPI_Combined.pem'),
                'handler' => $stack,
                'debug' => true,
                'curl' => [
